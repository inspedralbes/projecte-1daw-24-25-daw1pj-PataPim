...
<div align="left">
  ...
  <strong>Diagrames casos d'ús</strong>
  <p>
     <div> <h3> Diagrama Usuari </h3> <a href="docs/diagrames/Diagrama_CU_Usuari.drawio.png" target="_blank">📄 </a> </div>  <br><br>
    <div> <h3> Diagrama Tecnic </h3> <a href="docs/diagrames/Diagrama_CU_Tecnic.drawio.png" target="_blank">📄</a> </div><br><br>
    <div> <h3>Diagrama Administrador </h3> <a href="docs/diagrames/Diagrama_CU_Administrador.drawio.png" target="_blank">📄 </a> </div>
  </p>
</div>
